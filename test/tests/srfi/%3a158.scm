(import (rnrs)
	...
	(srfi :1)
	(srfi :158)
	(rename (srfi :64) (test-group srfi:test-group)))

(define-syntax test-group
  (syntax-rules (define)
    ((_ "collect" name () (defs ...) (tests ...))
     (srfi:test-group name defs ... tests ...))
    ((_ "collect" name ((define d ...) exprs ...) (defs ...) (tests ...))
     (test-group "collect" name
		 (exprs ...) (defs ... (define d ...)) (tests ...)))
    ((_ "collect" name (expr exprs ...) (defs ...) (tests ...))
     (test-group "collect" name (exprs ...) (defs ...) (tests ... expr)))
    ((_ name exprs ...)
     (test-group "collect" name (exprs ...) () ()))))

(define-syntax test (identifier-syntax test-equal))
(define-syntax test-exit (identifier-syntax test-end))

(define (bytevector . args) (u8-list->bytevector args))

(test-begin "SRFI 158 generators and accumulators")

;; test from the SRFI repository
...
(test-group "generators"
  ...
  (test-group "generators/consumers"
    ...
    (define g0 (make-range-generator 2 5))
    (test #t (generator-any odd? g0))
    (test '(4) (generator->list g0))
