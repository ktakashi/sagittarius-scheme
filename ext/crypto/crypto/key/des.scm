...
(define-generic generate-secret-key)
(define-method generate-secret-key ((o <symmetric-cipher-descriptor>) bv)
  (generate-symmetric-key o bv))
...
(define-method generate-secret-key ((type (eql *scheme:des3*))
				    (key <bytevector>))
