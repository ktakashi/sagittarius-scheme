...
;
    SG_RETURN = (Sg_MakePulicKeyCipher(name, key, enc, dec, padder));
    return SG_RETURN;
  }
}
static SG_DEFINE_SUBR(_sagittarius_crypto_impl_make_public_key_cipher_Stub, 5, 0, _sagittarius_crypto_impl_make_public_key_cipher, SG_FALSE, NULL);
