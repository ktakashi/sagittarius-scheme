...
(test-equal '(0 0 0 12 1 1 1)
	    (let-values ((r (absolute->gregorian 1 (timezone "GMT")))) r))
(test-equal '(0 0 0 13 1 1 1)
	    (let-values ((r (absolute->gregorian 1 (timezone "CET")))) r))
(test-equal '(0 0 0 12 31 12 -1)
	    (let-values ((r (absolute->gregorian 0 (timezone "GMT")))) r))
(test-equal '(0 0 0 0 1 1 1)
	    (let-values ((r (absolute->gregorian 0.5 (timezone "GMT")))) r))
