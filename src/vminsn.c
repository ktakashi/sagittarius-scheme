...
{long cise__78=INSN_VALUE1(c);{AC(vm)=(SG_MAKE_INT(cise__78));NEXT;}}}
}
...
{long cise__79=(SG_INT_VALUE(obj))+(SG_INT_VALUE(AC(vm)));if (((SG_INT_MIN)<=(cise__79))&&((SG_INT_MAX)>=(cise__79))){{AC(vm)=(SG_MAKE_INT(cise__79));NEXT;}} else {{AC(vm)=(Sg_MakeBignumFromSI(cise__79));NEXT;}}}} else {
...
if (SG_INTP(AC(vm))){
{long cise__80=(val1)+(SG_INT_VALUE(AC(vm)));if (((SG_INT_MIN)<=(cise__80))&&((SG_INT_MAX)>=(cise__80))){{AC(vm)=(SG_MAKE_INT(cise__80));NEXT;}} else {{AC(vm)=(Sg_MakeBignumFromSI(cise__80));NEXT;}}}} else {
...
{SgObject obj=POP(SP(vm));
if ((SG_INTP(AC(vm)))&&(SG_INTP(obj))){
{long cise__81=(SG_INT_VALUE(obj))-(SG_INT_VALUE(AC(vm)));if (((SG_INT_MIN)<=(cise__81))&&((SG_INT_MAX)>=(cise__81))){{AC(vm)=(SG_MAKE_INT(cise__81));NEXT;}} else {{AC(vm)=(Sg_MakeBignumFromSI(cise__81));NEXT;}}}} else {
...
if (SG_INTP(AC(vm))){
{long cise__82=(val1)-(SG_INT_VALUE(AC(vm)));if (((SG_INT_MIN)<=(cise__82))&&((SG_INT_MAX)>=(cise__82))){{AC(vm)=(SG_MAKE_INT(cise__82));NEXT;}} else {{AC(vm)=(Sg_MakeBignumFromSI(cise__82));NEXT;}}}} else {
...
(val1)>(0)){
{int i=0;int cise__84=val1;for (;(i)<(cise__84);(i)++){
...
{int i=0;int cise__83=numValues;for (;(i)<(cise__83);(i)++){
...
{int i=0;int cise__85=n;for (;(i)<(cise__85);(i)++){
...
if ((nargs)>(0)){{
ret=(AC(vm));
{int i=0;int cise__86=nargs;for (;(i)<(cise__86);(i)++){
...
{int i=0;int cise__87=n;for (;(i)<(cise__87);(i)++){
...
{long cise__88=SG_VECTOR_SIZE(AC(vm));{AC(vm)=(SG_MAKE_INT(cise__88));NEXT;}}}
}
...
{
#line 69 "instructions.scm"
{long cise__89=INSN_VALUE1(c);{PUSH(SP(vm),SG_MAKE_INT(cise__89));NEXT;}}}
}
