...
CASE(UNDEF) {
{
#line 32 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(SG_UNDEF);}
  NEXT;
}
CASE(CONST) {
{
#line 35 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(FETCH_OPERAND(PC(vm)));}
  NEXT;
}
CASE(CONSTI) {
{
#line 38 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 39 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(SG_MAKE_INT(val1));}
  NEXT;
}
CASE(LREF) {
{
#line 42 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 43 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(REFER_LOCAL(vm,val1));}
  NEXT;
}
CASE(LSET) {
{
#line 46 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 47 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(FREF) {
{
#line 51 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 52 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(INDEX_CLOSURE(vm,val1));}
  NEXT;
}
CASE(FSET) {
{
#line 55 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 56 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(GREF) {
{
#line 60 "d:/workspace/sagittarius/boot/instructions.scm"
...
#line 67 "d:/workspace/sagittarius/boot/instructions.scm"
if (SG_GLOCP(value)){
...
CASE(GSET) {
{
#line 78 "d:/workspace/sagittarius/boot/instructions.scm"
{SgObject var=FETCH_OPERAND(PC(vm));
if (SG_GLOCP(var)){
...
SG_IDENTIFIER_NAME(var),SG_UNBOUND);
#line 85 "d:/workspace/sagittarius/boot/instructions.scm"
...
AC(vm),0);
#line 93 "d:/workspace/sagittarius/boot/instructions.scm"
(*((PC(vm))-(1)))=(SG_WORD(g));}}}} else {
ASSERT(FALSE);}}}{
#line 95 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(SG_UNDEF);}
  NEXT;
}
CASE(PUSH) {
{
#line 98 "d:/workspace/sagittarius/boot/instructions.scm"
PUSH(SP(vm),AC(vm));}
  NEXT;
}
CASE(BOX) {
{
#line 101 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 102 "d:/workspace/sagittarius/boot/instructions.scm"
INDEX_SET(SP(vm),val1,make_box(INDEX(SP(vm),val1)));}
  NEXT;
}
CASE(UNBOX) {
{
#line 105 "d:/workspace/sagittarius/boot/instructions.scm"
ASSERT(SG_BOXP(AC(vm)));}{
#line 106 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=((SG_BOX(AC(vm)))->value);}
  NEXT;
}
CASE(ADD) {
{
#line 115 "d:/workspace/sagittarius/boot/instructions.scm"
...
#line 124 "d:/workspace/sagittarius/boot/instructions.scm"
{AC(vm)=(Sg_Add(obj,AC(vm)));(SP(vm))--;}}}}
  NEXT;
}
CASE(ADDI) {
{
#line 131 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 132 "d:/workspace/sagittarius/boot/instructions.scm"
if (SG_INTP(AC(vm))){
...
AC(vm)=(SG_MAKE_INT(n));} else {
AC(vm)=(Sg_MakeBignumFromSI(n));}}} else {
#line 139 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(Sg_Add(SG_MAKE_INT(val1),AC(vm)));}}
  NEXT;
}
CASE(SUB) {
{
#line 142 "d:/workspace/sagittarius/boot/instructions.scm"
{SgObject obj=INDEX(SP(vm),0);
if ((SG_INTP(AC(vm)))&&(SG_INTP(obj))){
{long n=(SG_INT_VALUE(obj))-(SG_INT_VALUE(AC(vm)));
(SP(vm))--;
...
AC(vm)=(SG_MAKE_INT(n));} else {
AC(vm)=(Sg_MakeBignumFromSI(n));}}} else {
#line 151 "d:/workspace/sagittarius/boot/instructions.scm"
{AC(vm)=(Sg_Sub(obj,AC(vm)));(SP(vm))--;}}}}
  NEXT;
}
CASE(SUBI) {
{
#line 154 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 155 "d:/workspace/sagittarius/boot/instructions.scm"
if (SG_INTP(AC(vm))){
{long n=(val1)-(SG_INT_VALUE(AC(vm)));
if (((SG_INT_MIN)<=(n))&&(
(SG_INT_MAX)>=(n))){
AC(vm)=(SG_MAKE_INT(n));} else {
AC(vm)=(Sg_MakeBignumFromSI(n));}}} else {
#line 162 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(Sg_Sub(SG_MAKE_INT(val1),AC(vm)));}}
  NEXT;
}
CASE(MUL) {
{
#line 165 "d:/workspace/sagittarius/boot/instructions.scm"
{AC(vm)=(Sg_Mul(INDEX(SP(vm),0),AC(vm)));(SP(vm))--;}}
  NEXT;
}
CASE(MULI) {
{
#line 168 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 169 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(Sg_Mul(SG_MAKE_INT(val1),AC(vm)));}
  NEXT;
}
CASE(DIV) {
{
#line 178 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(DIVI) {
{
#line 188 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 189 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(Sg_Div(SG_MAKE_INT(val1),AC(vm)));}
  NEXT;
}
CASE(NEG) {
{
#line 196 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(Sg_Negate(AC(vm)));}
  NEXT;
}
CASE(TEST) {
{
#line 199 "d:/workspace/sagittarius/boot/instructions.scm"
if (SG_FALSEP(AC(vm))){
{SgObject n=PEEK_OPERAND(PC(vm));
ASSERT(SG_INTP(n));
PC(vm)=((PC(vm))+(SG_INT_VALUE(n)));}} else {
#line 204 "d:/workspace/sagittarius/boot/instructions.scm"
(PC(vm))++;}}
  NEXT;
}
CASE(JUMP) {
{
#line 207 "d:/workspace/sagittarius/boot/instructions.scm"
{SgObject n=PEEK_OPERAND(PC(vm));
ASSERT(SG_INTP(n));
...
CASE(SHIFTJ) {
{
#line 212 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL2(val1,val2,c);}{
#line 213 "d:/workspace/sagittarius/boot/instructions.scm"
SP(vm)=(shift_args((FP(vm))+(val2),val1,SP(vm)));}
  NEXT;
}
CASE(BNNUME) {
{
#line 237 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(BNLT) {
{
#line 240 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(BNLE) {
{
#line 243 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(BNGT) {
{
#line 246 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(BNGE) {
{
#line 249 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(BNEQ) {
{
#line 264 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(BNEQV) {
{
#line 267 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(BNNULL) {
{
#line 281 "d:/workspace/sagittarius/boot/instructions.scm"
{SgObject n=PEEK_OPERAND(PC(vm));if (SG_NULLP(AC(vm))){{AC(vm)=(SG_TRUE);(PC(vm))++;}} else {{(PC(vm))+=(SG_INT_VALUE(n));AC(vm)=(SG_FALSE);}}}}
  NEXT;
}
CASE(NOT) {
{
#line 284 "d:/workspace/sagittarius/boot/instructions.scm"
if (SG_FALSEP(AC(vm))){
AC(vm)=(SG_TRUE);} else {
AC(vm)=(SG_FALSE);}}
  NEXT;
...
CASE(NUM_EQ) {
{
#line 298 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(NUM_LT) {
{
#line 301 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(NUM_LE) {
{
#line 304 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(NUM_GT) {
{
#line 307 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(NUM_GE) {
{
#line 310 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(RECEIVE) {
{
#line 313 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL2(val1,val2,c);}{
#line 314 "d:/workspace/sagittarius/boot/instructions.scm"
{int numValues=0;
if (SG_VALUESP(AC(vm))){
...
#line 321 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm));}}
if (((val2)==(0))&&(
(numValues)>(val1))){
{Sg_AssertionViolation(SG_INTERN("receive"),SG_MAKE_STRING("recieved more values than expected"),
#line 326 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm));}}
if ((val2)==(0)){
#line 329 "d:/workspace/sagittarius/boot/instructions.scm"
if ((val1)==(1)){
#line 331 "d:/workspace/sagittarius/boot/instructions.scm"
PUSH(SP(vm),AC(vm));}else if(
(val1)>(0)){
{int i=0;int cise__720=val1;for (;(i)<(cise__720);(i)++){
PUSH(SP(vm),SG_VALUES_ELEMENT(AC(vm),i));}}}}else if(
(val1)==(0)){
#line 337 "d:/workspace/sagittarius/boot/instructions.scm"
{SgObject h=SG_NIL;SgObject t=SG_NIL;
#line 339 "d:/workspace/sagittarius/boot/instructions.scm"
if ((numValues)==(1)){
SG_APPEND1(h,t,AC(vm));} else {
{int i=0;int cise__719=numValues;for (;(i)<(cise__719);(i)++){
SG_APPEND1(h,t,SG_VALUES_ELEMENT(AC(vm),i));}}}
PUSH(SP(vm),h);}} else {
#line 346 "d:/workspace/sagittarius/boot/instructions.scm"
{SgObject h=SG_NIL;SgObject t=SG_NIL;int i=0;
#line 349 "d:/workspace/sagittarius/boot/instructions.scm"
for (;;(i)++){
if ((i)<(val1)){
PUSH(SP(vm),SG_VALUES_ELEMENT(AC(vm),i));}else if(
(i)<(SG_VALUES_SIZE(AC(vm)))){
SG_APPEND1(h,t,SG_VALUES_ELEMENT(AC(vm),i));} else {
#line 355 "d:/workspace/sagittarius/boot/instructions.scm"
PUSH(SP(vm),h);
break;}}}}}}
  NEXT;
}
CASE(CLOSURE) {
{
#line 359 "d:/workspace/sagittarius/boot/instructions.scm"
...
#line 364 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(APPLY) {
{
#line 383 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL2(val1,val2,c);}{SgObject cise__721;
#line 384 "d:/workspace/sagittarius/boot/instructions.scm"
...
#line 399 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(CALL) {
{
#line 410 "d:/workspace/sagittarius/boot/instructions.scm"
#include "vmcall.c"
}
  NEXT;
}
CASE(LOCAL_CALL) {
{
#line 431 "d:/workspace/sagittarius/boot/instructions.scm"
CHECK_STACK(SG_CLOSURE_MAX_STACK(AC(vm)),vm);}{
#line 432 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(TAIL_CALL) {
{
#line 441 "d:/workspace/sagittarius/boot/instructions.scm"
{INSN_VAL1(val1,c);SP(vm)=(shift_args(FP(vm),val1,SP(vm)));}}{
#line 442 "d:/workspace/sagittarius/boot/instructions.scm"
#include "vmcall.c"
}
  NEXT;
}
...
{
#line 445 "d:/workspace/sagittarius/boot/instructions.scm"
CHECK_STACK(SG_CLOSURE_MAX_STACK(AC(vm)),vm);}{
#line 446 "d:/workspace/sagittarius/boot/instructions.scm"
{INSN_VAL1(val1,c);SP(vm)=(shift_args(FP(vm),val1,SP(vm)));}}{
#line 447 "d:/workspace/sagittarius/boot/instructions.scm"
{INSN_VAL1(val1,c);if (SG_CLOSUREP(AC(vm))){if ((SG_VM_LOG_LEVEL(vm,SG_DEBUG_LEVEL))&&(((vm)->state)==(RUNNING))){{Sg_Printf((vm)->logPort,UC("calling %S\n"),AC(vm));if ((SG_VM_LOG_LEVEL(vm,SG_TRACE_LEVEL))&&(((vm)->state)==(RUNNING))){{print_frames(vm);}}}}{SgCodeBuilder* cb=(SG_CLOSURE(AC(vm)))->code;CL(vm)=(AC(vm)),PC(vm)=((cb)->code),FP(vm)=((SP(vm))-(val1));}} else {ASSERT(FALSE);}}}
  NEXT;
}
CASE(RET) {
{
#line 450 "d:/workspace/sagittarius/boot/instructions.scm"
RET_INSN();}
  NEXT;
}
CASE(FRAME) {
{
#line 453 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(ENTER) {
{
#line 459 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 460 "d:/workspace/sagittarius/boot/instructions.scm"
FP(vm)=((SP(vm))-(val1));}
  NEXT;
}
CASE(LEAVE) {
{
#line 463 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 464 "d:/workspace/sagittarius/boot/instructions.scm"
SP(vm)=((SP(vm))-(val1));}
  NEXT;
}
CASE(DEFINE) {
{
#line 467 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 468 "d:/workspace/sagittarius/boot/instructions.scm"
{SgObject var=FETCH_OPERAND(PC(vm));
ASSERT(SG_IDENTIFIERP(var));
Sg_MakeBinding(SG_IDENTIFIER_LIBRARY(var),
SG_IDENTIFIER_NAME(var),
AC(vm),val1);
#line 474 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(SG_UNDEF);}}
  NEXT;
}
CASE(LIBRARY) {
{
#line 480 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(CAR) {
{
#line 484 "d:/workspace/sagittarius/boot/instructions.scm"
if ((!(SG_PAIRP(AC(vm))))){
{Sg_WrongTypeOfArgumentViolation(SG_INTERN("car"),SG_MAKE_STRING("pair"),AC(vm),SG_NIL);}}}{
#line 486 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(SG_CAR(AC(vm)));}
  NEXT;
}
CASE(CDR) {
{
#line 489 "d:/workspace/sagittarius/boot/instructions.scm"
if ((!(SG_PAIRP(AC(vm))))){
{Sg_WrongTypeOfArgumentViolation(SG_INTERN("cdr"),SG_MAKE_STRING("pair"),AC(vm),SG_NIL);}}}{
#line 491 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(SG_CDR(AC(vm)));}
  NEXT;
}
CASE(CONS) {
{
#line 494 "d:/workspace/sagittarius/boot/instructions.scm"
{AC(vm)=(Sg_Cons(INDEX(SP(vm),0),AC(vm)));(SP(vm))--;}}
  NEXT;
}
CASE(LIST) {
{
#line 497 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 498 "d:/workspace/sagittarius/boot/instructions.scm"
{int n=(val1)-(1);SgObject ret=SG_NIL;
#line 500 "d:/workspace/sagittarius/boot/instructions.scm"
if ((val1)>(0)){{
...
CASE(APPEND) {
{
#line 508 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 509 "d:/workspace/sagittarius/boot/instructions.scm"
{int nargs=(val1)-(1);SgObject ret=SG_NIL;
#line 511 "d:/workspace/sagittarius/boot/instructions.scm"
if ((nargs)>(0)){{
ret=(AC(vm));
...
#line 518 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(VALUES) {
{
#line 523 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 524 "d:/workspace/sagittarius/boot/instructions.scm"
if ((val1)==(0)){
...
CASE(EQ) {
{
#line 544 "d:/workspace/sagittarius/boot/instructions.scm"
{AC(vm)=(SG_MAKE_BOOL(SG_EQ(INDEX(SP(vm),0),AC(vm))));(SP(vm))--;}}
  NEXT;
}
CASE(EQV) {
{
#line 547 "d:/workspace/sagittarius/boot/instructions.scm"
{AC(vm)=(SG_MAKE_BOOL(Sg_EqvP(INDEX(SP(vm),0),AC(vm))));(SP(vm))--;}}
  NEXT;
}
CASE(NULLP) {
{
#line 550 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(SG_MAKE_BOOL(SG_NULLP(AC(vm))));}
  NEXT;
}
CASE(PAIRP) {
{
#line 553 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(SG_MAKE_BOOL(SG_PAIRP(AC(vm))));}
  NEXT;
}
CASE(SYMBOLP) {
{
#line 556 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(SG_MAKE_BOOL(SG_SYMBOLP(AC(vm))));}
  NEXT;
}
CASE(VECTOR) {
{
#line 559 "d:/workspace/sagittarius/boot/instructions.scm"
{SgObject v=SG_UNDEF;
INSN_VAL1(val1,c);
...
CASE(VECTORP) {
{
#line 573 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(SG_MAKE_BOOL(SG_VECTORP(AC(vm))));}
  NEXT;
}
CASE(VEC_LEN) {
{
#line 576 "d:/workspace/sagittarius/boot/instructions.scm"
if ((!(SG_VECTORP(AC(vm))))){
{Sg_WrongTypeOfArgumentViolation(SG_INTERN("vector-length"),SG_MAKE_STRING("vector"),
AC(vm),SG_NIL);}}}{
#line 579 "d:/workspace/sagittarius/boot/instructions.scm"
AC(vm)=(SG_MAKE_INT(SG_VECTOR_SIZE(AC(vm))));}
  NEXT;
}
CASE(VEC_REF) {
{
#line 582 "d:/workspace/sagittarius/boot/instructions.scm"
{SgObject obj=INDEX(SP(vm),0);
if (SG_VECTORP(obj)){
if (SG_INTP(AC(vm))){
...
CASE(VEC_SET) {
{
#line 597 "d:/workspace/sagittarius/boot/instructions.scm"
...
#line 603 "d:/workspace/sagittarius/boot/instructions.scm"
SG_LIST1(obj));}} else {
if (SG_INTP(index)){
...
#line 615 "d:/workspace/sagittarius/boot/instructions.scm"
{Sg_WrongTypeOfArgumentViolation(SG_INTERN("vector-set!"),SG_MAKE_STRING("vector"),obj,SG_NIL);}}}}
  NEXT;
}
CASE(LREF_PUSH) {
{
#line 620 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 621 "d:/workspace/sagittarius/boot/instructions.scm"
PUSH(SP(vm),REFER_LOCAL(vm,val1));}
  NEXT;
}
CASE(FREF_PUSH) {
{
#line 624 "d:/workspace/sagittarius/boot/instructions.scm"
INSN_VAL1(val1,c);}{
#line 625 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(CONST_PUSH) {
{
#line 631 "d:/workspace/sagittarius/boot/instructions.scm"
...
CASE(SET_CAR) {
{
#line 643 "d:/workspace/sagittarius/boot/instructions.scm"
{SgObject obj=INDEX(SP(vm),0);
if (SG_PAIRP(obj)){
...
#line 648 "d:/workspace/sagittarius/boot/instructions.scm"
{
...
CASE(SET_CDR) {
{
#line 656 "d:/workspace/sagittarius/boot/instructions.scm"
{SgObject obj=INDEX(SP(vm),0);
if (SG_PAIRP(obj)){
if (Sg_ConstantLiteralP(obj)){
{Sg_AssertionViolation(SG_INTERN("set-cdr!"),SG_MAKE_STRING("attempt to modify constant literal"),obj);}} else {
#line 661 "d:/workspace/sagittarius/boot/instructions.scm"
{
