...
static SG_DEFINE_SUBR(_sagittarius_current_directory_Stub, 0, 0, _sagittarius_current_directory, SG_FALSE, NULL);
...
static SG_DEFINE_SUBR(_sagittarius_clean_cache_Stub, 0, 0, _sagittarius_clean_cache, SG_FALSE, NULL);
