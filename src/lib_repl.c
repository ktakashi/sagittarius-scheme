...
static struct sg__wcRec {
  ...
  { /* code builder */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[72], NULL, 1, FALSE, 0, 8, 8), /* (read-eval-print-loop #:G10691) */
  ...
  /*     3 */        WORD(SG_UNDEF)  /* identifier#G10691 */,
  ...
  /*   146 */        WORD(SG_UNDEF)  /* identifier#G10691 */,
...
void Sg__Init_sagittarius_interactive()
{
  ...
  sg__wc.w[146] = sg__wc.w[3] = UNSIDENT("G10691", lib);
  ...
  sg__wc.w[50] = sg__wc.w[359] = IDENT("current-printer", lib);
  ...
  sg__wc.w[366] = sg__wc.w[268] = sg__wc.w[302] = sg__wc.w[337] = IDENT("current-output-port", lib);
  ...
  sg__wc.w[369] = sg__wc.w[271] = sg__wc.w[305] = sg__wc.w[340] = IDENT("flush-output-port", lib);
  sg__wc.w[171] = sg__wc.w[204] = sg__wc.w[104] = sg__wc.w[137] = IDENT("format", lib);
