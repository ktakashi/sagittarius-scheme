...
static struct sg__wcRec {
  ...
  { /* code builder */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[72], NULL, 1, FALSE, 0, 8, 8), /* (read-eval-print-loop #:G10652) */
  ...
  /*     3 */        WORD(SG_UNDEF)  /* identifier#G10652 */,
  ...
  /*   146 */        WORD(SG_UNDEF)  /* identifier#G10652 */,
...
void Sg__Init_sagittarius_interactive()
{
  ...
  sg__wc.w[146] = sg__wc.w[3] = UNSIDENT("G10652", lib);
