...
static struct sg__wcRec {
  ...
  { /* code builder */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[72], NULL, 1, FALSE, 0, 8, 8), /* (default-printer #:|#:10794|) */
  ...
  /*     3 */        WORD(SG_UNDEF)  /* identifier#|#:10794| */,
  ...
  /*   146 */        WORD(SG_UNDEF)  /* identifier#|#:10794| */,
...
void Sg__Init_sagittarius_interactive()
{
  ...
  sg__wc.w[302] = sg__wc.w[268] = sg__wc.w[366] = sg__wc.w[337] = IDENT("current-output-port", lib);
  sg__wc.w[9] = sg__wc.w[13] = IDENT("default-exception-printer", lib);
  sg__wc.w[54] = sg__wc.w[58] = IDENT("default-prompter", lib);
  sg__wc.w[369] = sg__wc.w[340] = sg__wc.w[305] = sg__wc.w[271] = IDENT("flush-output-port", lib);
  sg__wc.w[149] = IDENT("for-each", lib);
  sg__wc.w[33] = sg__wc.w[63] = sg__wc.w[18] = sg__wc.w[48] = IDENT("make-parameter", lib);
  ...
  sg__wc.w[124] = sg__wc.w[91] = sg__wc.w[158] = sg__wc.w[191] = IDENT("procedure?", lib);
  sg__wc.w[110] = sg__wc.w[177] = sg__wc.w[210] = sg__wc.w[143] = IDENT("values", lib);
