...
static struct sg__wcRec {
  ...
  { /* code builder */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[72], NULL, 1, FALSE, 0, 8, 8), /* (read-eval-print-loop #:G10591) */
  ...
  /*     3 */        WORD(SG_UNDEF)  /* identifier#G10591 */,
  ...
  /*   146 */        WORD(SG_UNDEF)  /* identifier#G10591 */,
...
void Sg__Init_sagittarius_interactive()
{
  ...
  sg__wc.w[146] = sg__wc.w[3] = UNSIDENT("G10591", lib);
  ...
  sg__wc.w[191] = sg__wc.w[124] = sg__wc.w[158] = sg__wc.w[91] = IDENT("procedure?", lib);
  ...
  sg__wc.w[340] = sg__wc.w[305] = sg__wc.w[369] = sg__wc.w[271] = IDENT("flush-output-port", lib);
