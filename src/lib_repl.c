...
static struct sg__wcRec {
  ...
  { /* code builder */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[72], NULL, 1, FALSE, 0, 8, 8), /* (read-eval-print-loop #:G10441) */
  ...
  /*     3 */        WORD(SG_UNDEF)  /* identifier#G10441 */,
  ...
  /*   146 */        WORD(SG_UNDEF)  /* identifier#G10441 */,
...
void Sg__Init_sagittarius_interactive()
{
  ...
  sg__wc.w[146] = sg__wc.w[3] = UNSIDENT("G10441", lib);
  sg__wc.w[337] = sg__wc.w[268] = sg__wc.w[366] = sg__wc.w[302] = IDENT("current-output-port", lib);
  sg__wc.w[91] = sg__wc.w[124] = sg__wc.w[191] = sg__wc.w[158] = IDENT("procedure?", lib);
  sg__wc.w[305] = sg__wc.w[340] = sg__wc.w[369] = sg__wc.w[271] = IDENT("flush-output-port", lib);
  sg__wc.w[48] = sg__wc.w[18] = sg__wc.w[63] = sg__wc.w[33] = IDENT("make-parameter", lib);
  sg__wc.w[110] = sg__wc.w[210] = sg__wc.w[177] = sg__wc.w[143] = IDENT("values", lib);
  sg__wc.w[207] = sg__wc.w[174] = sg__wc.w[140] = sg__wc.w[107] = IDENT("assertion-violation", lib);
  sg__wc.w[104] = sg__wc.w[204] = sg__wc.w[171] = sg__wc.w[137] = IDENT("format", lib);
