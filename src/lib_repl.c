...
void Sg__Init_sagittarius_interactive()
{
  ...
  sg__wc.w[268] = sg__wc.w[302] = sg__wc.w[366] = sg__wc.w[337] = IDENT("current-output-port", lib);
  ...
  sg__wc.w[271] = sg__wc.w[305] = sg__wc.w[369] = sg__wc.w[340] = IDENT("flush-output-port", lib);
  sg__wc.w[63] = sg__wc.w[18] = sg__wc.w[33] = sg__wc.w[48] = IDENT("make-parameter", lib);
  sg__wc.w[246] = IDENT("call-with-current-continuation", lib);
  sg__wc.w[204] = sg__wc.w[104] = sg__wc.w[137] = sg__wc.w[171] = IDENT("format", lib);
  sg__wc.w[124] = sg__wc.w[158] = sg__wc.w[191] = sg__wc.w[91] = IDENT("procedure?", lib);
  ...
  sg__wc.w[143] = sg__wc.w[177] = sg__wc.w[210] = sg__wc.w[110] = IDENT("values", lib);
  sg__wc.w[207] = sg__wc.w[107] = sg__wc.w[140] = sg__wc.w[174] = IDENT("assertion-violation", lib);
