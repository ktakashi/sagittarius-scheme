...
void Sg__Init_sagittarius_interactive()
{
  ...
  sg__wc.w[174] = sg__wc.w[140] = sg__wc.w[207] = sg__wc.w[107] = IDENT("assertion-violation", lib);
  ...
  sg__wc.w[63] = sg__wc.w[33] = sg__wc.w[18] = sg__wc.w[48] = IDENT("make-parameter", lib);
  ...
  sg__wc.w[268] = sg__wc.w[337] = sg__wc.w[366] = sg__wc.w[302] = IDENT("current-output-port", lib);
  sg__wc.w[9] = sg__wc.w[13] = IDENT("default-exception-printer", lib);
  sg__wc.w[369] = sg__wc.w[305] = sg__wc.w[271] = sg__wc.w[340] = IDENT("flush-output-port", lib);
  sg__wc.w[177] = sg__wc.w[143] = sg__wc.w[210] = sg__wc.w[110] = IDENT("values", lib);
