...
static struct sg__wcRec {
  ...
  { /* code builder */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[72], NULL, 1, FALSE, 0, 8, 8), /* (read-eval-print-loop #:G10434) */
  ...
  /*     3 */        WORD(SG_UNDEF)  /* identifier#G10434 */,
  ...
  /*   146 */        WORD(SG_UNDEF)  /* identifier#G10434 */,
...
void Sg__Init_sagittarius_interactive()
{
  ...
  sg__wc.w[366] = sg__wc.w[268] = sg__wc.w[337] = sg__wc.w[302] = IDENT("current-output-port", lib);
  sg__wc.w[234] = IDENT("getenv", lib);
  sg__wc.w[146] = sg__wc.w[3] = UNSIDENT("G10434", lib);
  sg__wc.w[50] = sg__wc.w[359] = IDENT("current-printer", lib);
  sg__wc.w[69] = IDENT("read-eval-print-loop", lib);
  sg__wc.w[124] = sg__wc.w[191] = sg__wc.w[158] = sg__wc.w[91] = IDENT("procedure?", lib);
  sg__wc.w[204] = sg__wc.w[171] = sg__wc.w[137] = sg__wc.w[104] = IDENT("format", lib);
  ...
  sg__wc.w[305] = sg__wc.w[271] = sg__wc.w[340] = sg__wc.w[369] = IDENT("flush-output-port", lib);
