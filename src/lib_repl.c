...
static struct sg__wcRec {
  ...
  { /* code builder */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[72], NULL, 1, FALSE, 0, 8, 8), /* (read-eval-print-loop #:G10686) */
  ...
  /*     3 */        WORD(SG_UNDEF)  /* identifier#G10686 */,
  ...
  /*   146 */        WORD(SG_UNDEF)  /* identifier#G10686 */,
...
void Sg__Init_sagittarius_interactive()
{
  ...
  sg__wc.w[366] = sg__wc.w[302] = sg__wc.w[268] = sg__wc.w[337] = IDENT("current-output-port", lib);
  ...
  sg__wc.w[146] = sg__wc.w[3] = UNSIDENT("G10686", lib);
