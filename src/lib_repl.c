...
void Sg__Init_sagittarius_interactive()
{
  ...
  sg__wc.w[63] = sg__wc.w[33] = sg__wc.w[48] = sg__wc.w[18] = IDENT("make-parameter", lib);
  sg__wc.w[174] = sg__wc.w[207] = sg__wc.w[107] = sg__wc.w[140] = IDENT("assertion-violation", lib);
