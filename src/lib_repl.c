...
static struct sg__wcRec {
  ...
  { /* code builder */
    ...
    SG_STATIC_CODE_BUILDER(&sg__wc.w[212], NULL, 0, FALSE, 0, 16, 39), /* read-eval-print-loop */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[251], NULL, 1, FALSE, 2, 10, 12), /* #f */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[263], NULL, 1, FALSE, 1, 9, 27), /* #f */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[290], NULL, 0, FALSE, 2, 21, 81), /* #f */
  },
  { /* compiled code */
  ...
  /*   314 */        WORD(SG_UNDEF)  /* identifier#read */,
...
void Sg__Init_sagittarius_interactive()
{
  ...
  sg__wc.w[302] = sg__wc.w[366] = sg__wc.w[268] = sg__wc.w[337] = IDENT("current-output-port", lib);
  sg__wc.w[305] = sg__wc.w[369] = sg__wc.w[271] = sg__wc.w[340] = IDENT("flush-output-port", lib);
  sg__wc.w[9] = sg__wc.w[13] = IDENT("default-exception-printer", lib);
  sg__wc.w[171] = sg__wc.w[137] = sg__wc.w[204] = sg__wc.w[104] = IDENT("format", lib);
  sg__wc.w[182] = IDENT("display", lib);
  sg__wc.w[311] = IDENT("current-input-port", lib);
  sg__wc.w[91] = sg__wc.w[158] = sg__wc.w[124] = sg__wc.w[191] = IDENT("procedure?", lib);
  sg__wc.w[146] = sg__wc.w[3] = UNSIDENT("G10680", lib);
  sg__wc.w[149] = IDENT("for-each", lib);
  sg__wc.w[314] = IDENT("read", lib);
  sg__wc.w[110] = sg__wc.w[177] = sg__wc.w[143] = sg__wc.w[210] = IDENT("values", lib);
