...
static struct sg__wcRec {
  ...
  { /* code builder */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[72], NULL, 1, FALSE, 0, 8, 8), /* (read-eval-print-loop #:G10559) */
  ...
  /*     3 */        WORD(SG_UNDEF)  /* identifier#G10559 */,
  ...
  /*   146 */        WORD(SG_UNDEF)  /* identifier#G10559 */,
...
void Sg__Init_sagittarius_interactive()
{
  ...
  sg__wc.w[146] = sg__wc.w[3] = UNSIDENT("G10559", lib);
  ...
  sg__wc.w[204] = sg__wc.w[104] = sg__wc.w[171] = sg__wc.w[137] = IDENT("format", lib);
  sg__wc.w[63] = sg__wc.w[48] = sg__wc.w[18] = sg__wc.w[33] = IDENT("make-parameter", lib);
  ...
  sg__wc.w[207] = sg__wc.w[107] = sg__wc.w[174] = sg__wc.w[140] = IDENT("assertion-violation", lib);
  sg__wc.w[54] = sg__wc.w[58] = IDENT("default-prompter", lib);
  sg__wc.w[115] = IDENT("eval", lib);
  sg__wc.w[271] = sg__wc.w[369] = sg__wc.w[305] = sg__wc.w[340] = IDENT("flush-output-port", lib);
