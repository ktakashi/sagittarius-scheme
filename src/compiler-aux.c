...
static struct sg__wcRec {
  ...
  { /* code builder */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[87], NULL, 1, FALSE, 0, 9, 24),
    SG_STATIC_CODE_BUILDER(&sg__wc.w[111], NULL, 1, FALSE, 0, 8, 22),
    SG_STATIC_CODE_BUILDER(&sg__wc.w[133], NULL, 1, FALSE, 0, 15, 42),
  },
  { /* compiled code */
  ...
  /*   105 */        0x00000047           /* 18     (CONST_PUSH) */,
  /*   106 */        WORD(SG_UNDEF), /* "invalid library tag:" */
  /*   107 */        0x00000044           /* 20     (LREF_PUSH) */,
  /*   108 */        0x0000024A           /* 21     (GREF_TAIL_CALL) */,
  /*   109 */        WORD(SG_UNDEF)  /* identifier#error */,
  /*   110 */        0x00000030           /* 23     (RET) */,
  /*   111 */        0x00000031           /* 0      (FRAME) */,
  /*   112 */        WORD(SG_MAKE_INT(4)),
  /*   113 */        0x00000044           /* 2      (LREF_PUSH) */,
  /*   114 */        0x00000149           /* 3      (GREF_CALL) */,
  /*   115 */        WORD(SG_UNDEF)  /* identifier#pair? */,
  /*   116 */        0x00000017           /* 5      (TEST) */,
  /*   117 */        WORD(SG_MAKE_INT(10)),
  /*   118 */        0x00000031           /* 7      (FRAME) */,
  /*   119 */        WORD(SG_MAKE_INT(4)),
  /*   120 */        0x00000044           /* 9      (LREF_PUSH) */,
  /*   121 */        0x00000149           /* 10     (GREF_CALL) */,
  /*   122 */        WORD(SG_UNDEF)  /* identifier#length */,
  /*   123 */        0x0000000B           /* 12     (PUSH) */,
  /*   124 */        0x00000003           /* 13     (CONST) */,
  /*   125 */        WORD(SG_MAKE_INT(2)),
  /*   126 */        0x00000024           /* 15     (NUM_EQ) */,
  /*   127 */        0x00000017           /* 16     (TEST) */,
  /*   128 */        WORD(SG_MAKE_INT(4)),
  /*   129 */        0x00000044           /* 18     (LREF_PUSH) */,
  /*   130 */        0x0000014A           /* 19     (GREF_TAIL_CALL) */,
  /*   131 */        WORD(SG_UNDEF)  /* identifier#cadr */,
  /*   132 */        0x00000030           /* 21     (RET) */,
  /*   133 */        0x00000332           /* 0      (LET_FRAME) */,
  /*   134 */        0x00000044           /* 1      (LREF_PUSH) */,
  /*   135 */        0x00000134           /* 2      (DISPLAY) */,
  /*   136 */        0x00000044           /* 3      (LREF_PUSH) */,
  /*   137 */        0x00000047           /* 4      (CONST_PUSH) */,
  /*   138 */        WORD(SG_MAKE_INT(0)),
  /*   139 */        0x00000233           /* 6      (POP_LET_FRAME) */,
  /*   140 */        0x0000001A           /* 7      (MARK) */,
  /*   141 */        0x00000005           /* 8      (LREF) */,
  /*   142 */        0x00000022           /* 9      (BNNULL) */,
  /*   143 */        WORD(SG_MAKE_INT(8)),
  /*   144 */        0x00000144           /* 11     (LREF_PUSH) */,
  /*   145 */        0x00000047           /* 12     (CONST_PUSH) */,
  /*   146 */        WORD(SG_MAKE_BOOL(FALSE)),
  /*   147 */        0x0000024A           /* 14     (GREF_TAIL_CALL) */,
  /*   148 */        WORD(SG_UNDEF)  /* identifier#values */,
  /*   149 */        0x00000018           /* 16     (JUMP) */,
  /*   150 */        WORD(SG_MAKE_INT(24)),
  /*   151 */        0x00000031           /* 18     (FRAME) */,
  /*   152 */        WORD(SG_MAKE_INT(4)),
  /*   153 */        0x00000044           /* 20     (LREF_PUSH) */,
  /*   154 */        0x00000149           /* 21     (GREF_CALL) */,
  /*   155 */        WORD(SG_UNDEF)  /* identifier#pair? */,
  /*   156 */        0x00000017           /* 23     (TEST) */,
  /*   157 */        WORD(SG_MAKE_INT(12)),
  /*   158 */        0x00000005           /* 25     (LREF) */,
  /*   159 */        0x00000039           /* 26     (CDR) */,
  /*   160 */        0x0000000B           /* 27     (PUSH) */,
  /*   161 */        0x00000105           /* 28     (LREF) */,
  /*   162 */        0x0000010F           /* 29     (ADDI) */,
  /*   163 */        0x0000000B           /* 30     (PUSH) */,
  /*   164 */        0x00000219           /* 31     (SHIFTJ) */,
  /*   165 */        0x00000018           /* 32     (JUMP) */,
  /*   166 */        WORD(SG_MAKE_INT(-25)),
  /*   167 */        0x00000018           /* 34     (JUMP) */,
  /*   168 */        WORD(SG_MAKE_INT(6)),
  /*   169 */        0x00000144           /* 36     (LREF_PUSH) */,
  /*   170 */        0x00000047           /* 37     (CONST_PUSH) */,
  /*   171 */        WORD(SG_MAKE_BOOL(TRUE)),
  /*   172 */        0x0000024A           /* 39     (GREF_TAIL_CALL) */,
  /*   173 */        WORD(SG_UNDEF)  /* identifier#values */,
  /*   174 */        0x00000030           /* 41     (RET) */,
  }
};
...
void Sg__Init_sagittarius_compiler_util()
{
  ...
  sg__wc.w[173] = IDENT("values", lib);
  sg__wc.w[115] = IDENT("pair?", lib);
  sg__wc.w[106] = STRINGW("invalid library tag:");
  sg__wc.w[155] = IDENT("pair?", lib);
  sg__wc.w[44] = IDENT("$CONST", lib);
  sg__wc.w[28] = IDENT("$LREF", lib);
  sg__wc.w[122] = IDENT("length", lib);
