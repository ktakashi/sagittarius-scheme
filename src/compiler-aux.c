...
static struct sg__wcRec {
  ...
  { /* code builder */
    ...
    SG_STATIC_CODE_BUILDER(&sg__wc.w[100], NULL, 1, 0, 0, 14, 27), /* parse-args */
  },
  { /* compiled code */
  ...
  /*   108 */        0x0000023A           /* 8      (VALUES) */,
  /*   109 */        0x0000002F           /* 9      (RET) */,
  ...
  /*   124 */        WORD(SG_MAKE_BOOL(TRUE)),
  /*   125 */        0x0000023A           /* 25     (VALUES) */,
  /*   126 */        0x0000002F           /* 26     (RET) */,
  }
};
