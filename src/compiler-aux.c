...
static struct sg__wcRec {
  ...
  { /* code builder */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[71], NULL, 1, 0, 0, 14, 36), /* ensure-library-name */
    SG_STATIC_CODE_BUILDER(&sg__wc.w[107], NULL, 1, 0, 0, 14, 27), /* parse-args */
  },
  { /* compiled code */
  ...
  /*    92 */        0x00000045           /* 21     (LREF_PUSH) */,
  /*    93 */        0x00000003           /* 22     (CONST) */,
  /*    94 */        WORD(SG_UNDEF)  /* <keyrowd :r7rs> */,
  /*    95 */        0x00000020           /* 24     (BNEQV) */,
  /*    96 */        WORD(3),
  /*    97 */        0x00000061           /* 26     (CONST_RET) */,
  /*    98 */        WORD(SG_UNDEF), /* (r7rs) */
  /*    99 */        0x00000048           /* 28     (CONST_PUSH) */,
  /*   100 */        WORD(SG_UNDEF), /* ensure-library-name */
  /*   101 */        0x00000048           /* 30     (CONST_PUSH) */,
  /*   102 */        WORD(SG_UNDEF), /* "invalid library tag:" */
  /*   103 */        0x00000045           /* 32     (LREF_PUSH) */,
  /*   104 */        0x0000034B           /* 33     (GREF_TAIL_CALL) */,
  /*   105 */        WORD(SG_UNDEF)  /* identifier#error */,
  /*   106 */        0x0000002F           /* 35     (RET) */,
  /*   107 */        0x00000045           /* 0      (LREF_PUSH) */,
  /*   108 */        0x00000049           /* 1      (CONSTI_PUSH) */,
  /*   109 */        0x00000105           /* 2      (LREF) */,
  /*   110 */        0x00000021           /* 3      (BNNULL) */,
  /*   111 */        WORD(6),
  /*   112 */        0x00000245           /* 5      (LREF_PUSH) */,
  /*   113 */        0x00000003           /* 6      (CONST) */,
  /*   114 */        WORD(SG_MAKE_BOOL(FALSE)),
  /*   115 */        0x0000023A           /* 8      (VALUES) */,
  /*   116 */        0x0000002F           /* 9      (RET) */,
  /*   117 */        0x00000105           /* 10     (LREF) */,
  /*   118 */        0x0000003E           /* 11     (PAIRP) */,
  /*   119 */        0x00000017           /* 12     (TEST) */,
  /*   120 */        WORD(9),
  /*   121 */        0x0000015C           /* 14     (LREF_CDR_PUSH) */,
  /*   122 */        0x00000205           /* 15     (LREF) */,
  /*   123 */        0x0000010F           /* 16     (ADDI) */,
  /*   124 */        0x0000000B           /* 17     (PUSH) */,
  /*   125 */        0x00100219           /* 18     (SHIFTJ) */,
  /*   126 */        0x00000018           /* 19     (JUMP) */,
  /*   127 */        WORD(-18),
  /*   128 */        0x0000002F           /* 21     (RET) */,
  /*   129 */        0x00000245           /* 22     (LREF_PUSH) */,
  /*   130 */        0x00000003           /* 23     (CONST) */,
  /*   131 */        WORD(SG_MAKE_BOOL(TRUE)),
  /*   132 */        0x0000023A           /* 25     (VALUES) */,
  /*   133 */        0x0000002F           /* 26     (RET) */,
  }
};
...
void Sg__Init_sagittarius_compiler_util()
{
  ...
  sg__wc.w[98] = WORD(Sg_Cons(SYMBOL("r7rs"), SG_NIL));
  ...
  sg__wc.w[100] = SYMBOLW("ensure-library-name");
