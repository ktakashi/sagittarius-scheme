...
static SgObject _sagittarius_vm_user_defined_syntax3f(SgObject *args, int argc, void *data_)
{
  ...
  {
    int SG_RETURN;
SG_RETURN = SG_USER_DEFINED_SYNTXP(s);
;
    return SG_MAKE_BOOL(SG_RETURN);
  }
}
...
static SgObject _sagittarius_vm_make_macro(SgObject *args, int argc, void *data_)
{
  ...
  {
    SgObject SG_RETURN;
SG_RETURN = Sg_MakeMacro(name, transformer, data, maybe_library);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_make_macro_transformer(SgObject *args, int argc, void *data_)
{
  ...
  {
    SgObject SG_RETURN;
SG_RETURN = Sg_MakeMacroTransformer(name, proc, library);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_find_binding(SgObject *args, int argc, void *data_)
{
  ...
  {
    SgObject SG_RETURN;
SG_RETURN = Sg_FindBinding(arg0, arg1);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_code_builder_finish_builder(SgObject *args, int argc, void *data_)
{
  ...
  {
    SgObject SG_RETURN;
SG_RETURN = Sg_CodeBuilderFinishBuilder(cb, need_halt);
;
    return SG_RETURN;
  }
}
