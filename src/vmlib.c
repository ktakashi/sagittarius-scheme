...
static SgObject _sagittarius_vm_make_identifier(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_MakeIdentifier(name, envs, library);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_id_name(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = SG_IDENTIFIER_NAME(id);
;
    return SG_RETURN;
  }
}
static SG_DEFINE_SUBR(_sagittarius_vm_id_name_Stub, 1, 0, _sagittarius_vm_id_name, SG_FALSE, NULL);
...
static SgObject _sagittarius_vm_id_envs(SgObject *args, int argc, void *data_)
{
  ...
  argumentAsIdentifier(0, id_scm, id);
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = SG_IDENTIFIER_ENVS(id);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_id_library(SgObject *args, int argc, void *data_)
{
  ...
  argumentAsIdentifier(0, id_scm, id);
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = SG_IDENTIFIER_LIBRARY(id);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_copy_identifier(SgObject *args, int argc, void *data_)
{
  ...
  argumentAsIdentifier(0, id_scm, id);
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_CopyIdentifier(id);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_make_syntax(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_MakeSyntax(name, proc, userDefined);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_syntax_name(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = SG_SYNTAX_NAME(arg0);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_syntax_proc(SgObject *args, int argc, void *data_)
{
  ...
  argumentAsSyntax(0, arg0_scm, arg0);
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = SG_SYNTAX_PROC(arg0);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_syntax3f(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(0, arg0);
  {
int SG_RETURN;SG_RETURN = SG_SYNTAXP(arg0);
;
...
static SgObject _sagittarius_vm_builtin_syntax3f(SgObject *args, int argc, void *data_)
{
  DeclareProcedureName("builtin-syntax?");
  SgObject s;
  checkArgumentLength(1);
  argumentRef(0, s);
  {
int SG_RETURN;SG_RETURN = SG_BUILTIN_SYNTXP(s);
;
    return SG_MAKE_BOOL(SG_RETURN);
  }
}
static SG_DEFINE_SUBR(_sagittarius_vm_builtin_syntax3f_Stub, 1, 0, _sagittarius_vm_builtin_syntax3f, SG_FALSE, NULL);

static SgObject _sagittarius_vm_user_defined_syntax3f(SgObject *args, int argc, void *data_)
{
  DeclareProcedureName("user-defined-syntax?");
  SgObject s;
  checkArgumentLength(1);
  argumentRef(0, s);
  {
int SG_RETURN;SG_RETURN = SG_USER_DEFINED_SYNTXP(s);
;
    return SG_MAKE_BOOL(SG_RETURN);
  }
}
static SG_DEFINE_SUBR(_sagittarius_vm_user_defined_syntax3f_Stub, 1, 0, _sagittarius_vm_user_defined_syntax3f, SG_FALSE, NULL);

static SgObject _sagittarius_vm_unwrap_syntax(SgObject *args, int argc, void *data_)
{
...
static SG_DEFINE_SUBR(_sagittarius_vm_unwrap_syntax_Stub, 1, 0, _sagittarius_vm_unwrap_syntax, SG_FALSE, NULL);
...
static SgObject _sagittarius_vm_call_syntax_handler(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(2, p1env);
  {
SgObject SG_RETURN = SG_UNDEF;if (SG_BUILTIN_SYNTXP(s)) {
SG_RETURN = Sg_Apply(SG_SYNTAX_PROC(s), SG_LIST2(expr, p1env));
;
}
 else {
Sg_Error(UC("call-syntax-handler: bug?"));
}
;
    return SG_RETURN;
  }
...
static SgObject _sagittarius_vm_macro3f(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(0, obj);
  {
int SG_RETURN;SG_RETURN = SG_MACROP(obj);
;
    return SG_MAKE_BOOL(SG_RETURN);
  }
}
...
static SgObject _sagittarius_vm_make_macro(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(2, data);
  if (argc >= 4) {
    argumentRef(3, maybe_library);
  } else {
    maybe_library = SG_MAKE_BOOL(FALSE);
  }

  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_MakeMacro(name, transformer, data, maybe_library);
;
    return SG_RETURN;
  }
}
static SG_DEFINE_SUBR(_sagittarius_vm_make_macro_Stub, 3, 1, _sagittarius_vm_make_macro, SG_FALSE, NULL);
...
static SgObject _sagittarius_vm_make_macro_transformer(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(0, name);
  argumentRef(1, proc);
  argumentRef(2, library);
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_MakeMacroTransformer(name, proc, library);
;
    return SG_RETURN;
  }
}
static SG_DEFINE_SUBR(_sagittarius_vm_make_macro_transformer_Stub, 3, 0, _sagittarius_vm_make_macro_transformer, SG_FALSE, NULL);
...
static SgObject _sagittarius_vm_call_macro_expander(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;{
  SgObject applyArgs = SG_LIST4(macro, expr, p1env, macro->data);
SG_RETURN = Sg_Apply(macro->transformer, applyArgs);
;
}
;
    return SG_RETURN;
...
static SgObject _sagittarius_vm_25internal_macro_expand(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_MacroExpand(expr, p1env, onceP);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_make_library(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(0, name);
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_MakeLibrary(name);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_library3f(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(0, arg0);
  {
int SG_RETURN;SG_RETURN = SG_LIBRARYP(arg0);
;
    return SG_MAKE_BOOL(SG_RETURN);
  }
}
...
static SgObject _sagittarius_vm_library_name(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = SG_LIBRARY_NAME(arg0);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_library_imported(SgObject *args, int argc, void *data_)
{
  ...
  argumentAsLibrary(0, arg0_scm, arg0);
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = SG_LIBRARY_IMPORTED(arg0);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_library_imported_set21(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(1, arg1);
  {
SgObject SG_RETURN = SG_UNDEF;SG_LIBRARY_IMPORTED(arg0)=arg1;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_library_exported_set21(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(1, arg1);
  {
SgObject SG_RETURN = SG_UNDEF;SG_LIBRARY_EXPORTED(arg0)=arg1;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_find_library(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_FindLibrary(arg0, createp);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_find_binding(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_FindBinding(arg0, arg1);
;
    return SG_RETURN;
  }
}
static SG_DEFINE_SUBR(_sagittarius_vm_find_binding_Stub, 2, 0, _sagittarius_vm_find_binding, SG_FALSE, NULL);

static SgObject _sagittarius_vm_load_library(SgObject *args, int argc, void *data_)
{
  DeclareProcedureName("load-library");
  SgObject to;
  SgObject from;
  checkArgumentLength(2);
  argumentRef(0, to);
  argumentRef(1, from);
  {
SgObject SG_RETURN = SG_UNDEF;Sg_ImportLibrary(to, from);
    return SG_RETURN;
  }
}
static SG_DEFINE_SUBR(_sagittarius_vm_load_library_Stub, 2, 0, _sagittarius_vm_load_library, SG_FALSE, NULL);
...
vm->currentLibrary=SG_CAR(name);SG_RETURN = SG_UNDEF;
;;}
;
}
;
...
static SgObject _sagittarius_vm_make_code_builder(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_MakeCodeBuilder(2);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_cb_emit021(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;Sg_CodeBuilderEmit(cb, insn, ARGUMENT0, 0, 0, SG_UNDEF);
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_cb_emit121(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;Sg_CodeBuilderEmit(cb, insn, ARGUMENT0, arg0, 0, SG_UNDEF);
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_cb_emit221(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;Sg_CodeBuilderEmit(cb, insn, ARGUMENT0, arg0, arg1, SG_UNDEF);
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_cb_emit0o21(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(2, obj);
  {
SgObject SG_RETURN = SG_UNDEF;Sg_CodeBuilderEmit(cb, insn, ARGUMENT1, 0, 0, obj);
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_cb_emit1oi21(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(4, src);
  {
SgObject SG_RETURN = SG_UNDEF;Sg_CodeBuilderEmit(cb, insn, ARGUMENT1, arg0, 0, obj);
Sg_CodeBuilderAddSrc(cb, insn, src);
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_cb_label_set21(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(1, label);
  {
SgObject SG_RETURN = SG_UNDEF;Sg_CodeBuilderLabelSet(cb, label);
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_vm_cb_emit_closure21(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(8, src);
  {
SgObject SG_RETURN = SG_UNDEF;SG_CODE_BUILDER_NAME(lambda_cb)=name;
...
static SgObject _sagittarius_vm_code_builder_finish_builder(SgObject *args, int argc, void *data_)
{
  ...
  SgObject cb_scm;
  SgCodeBuilder *cb;
  SgObject need_halt_scm;
  int need_halt;
  checkArgumentLength(2);
  argumentAsCodeBuilder(0, cb_scm, cb);
  argumentAsBoolean(1, need_halt_scm, need_halt);
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_CodeBuilderFinishBuilder(cb, need_halt);
;
    return SG_RETURN;
  }
}
...
SG_APPEND1(h, t, Sg_Cons(SG_CAR(l1), SG_CAR(l2)));l1=SG_CDR(l1);l2=SG_CDR(l2);}
;
SG_RETURN = h;
;
}
...
static SgObject _sagittarius_vm_make_toplevel_closure(SgObject *args, int argc, void *data_)
{
  ...
  argumentAsCodeBuilder(0, cb_scm, cb);
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_MakeClosure(cb, NULL);
;
    return SG_RETURN;
  }
}
static SG_DEFINE_SUBR(_sagittarius_vm_make_toplevel_closure_Stub, 1, 0, _sagittarius_vm_make_toplevel_closure, SG_FALSE, NULL);
...
static SgObject _sagittarius_vm_pass32fframe_size(SgObject *args, int argc, void *data_)
{
  ...
  checkArgumentLength(0);
  {
int SG_RETURN;SG_RETURN = SG_FRAME_SIZE;
;
...
static SgObject _sagittarius_vm_pass32flet_frame_size(SgObject *args, int argc, void *data_)
{
  ...
  checkArgumentLength(0);
  {
int SG_RETURN;SG_RETURN = SG_LET_FRAME_SIZE;
;
    return SG_MAKE_INT(SG_RETURN);
  }
}
...
void Sg__Init_sagittarius_vm()
{
  ...
  SG_PROCEDURE_NAME(&_sagittarius_vm_user_defined_syntax3f_Stub) = Sg_MakeString(UC("user-defined-syntax?"), SG_LITERAL_STRING);
  Sg_InsertBinding(lib, Sg_Intern(Sg_MakeString(UC("user-defined-syntax?"), SG_LITERAL_STRING)), SG_OBJ(&_sagittarius_vm_user_defined_syntax3f_Stub));
  ...
  SG_PROCEDURE_NAME(&_sagittarius_vm_unwrap_syntax_Stub) = Sg_MakeString(UC("unwrap-syntax"), SG_LITERAL_STRING);
  Sg_InsertBinding(lib, Sg_Intern(Sg_MakeString(UC("unwrap-syntax"), SG_LITERAL_STRING)), SG_OBJ(&_sagittarius_vm_unwrap_syntax_Stub));
  ...
  SG_PROCEDURE_NAME(&_sagittarius_vm_builtin_syntax3f_Stub) = Sg_MakeString(UC("builtin-syntax?"), SG_LITERAL_STRING);
  Sg_InsertBinding(lib, Sg_Intern(Sg_MakeString(UC("builtin-syntax?"), SG_LITERAL_STRING)), SG_OBJ(&_sagittarius_vm_builtin_syntax3f_Stub));
  SG_PROCEDURE_NAME(&_sagittarius_vm_load_library_Stub) = Sg_MakeString(UC("load-library"), SG_LITERAL_STRING);
  Sg_InsertBinding(lib, Sg_Intern(Sg_MakeString(UC("load-library"), SG_LITERAL_STRING)), SG_OBJ(&_sagittarius_vm_load_library_Stub));
  ...
  SG_PROCEDURE_NAME(&_sagittarius_vm_id_name_Stub) = Sg_MakeString(UC("id-name"), SG_LITERAL_STRING);
  Sg_InsertBinding(lib, Sg_Intern(Sg_MakeString(UC("id-name"), SG_LITERAL_STRING)), SG_OBJ(&_sagittarius_vm_id_name_Stub));
  ...
  SG_PROCEDURE_NAME(&_sagittarius_vm_make_toplevel_closure_Stub) = Sg_MakeString(UC("make-toplevel-closure"), SG_LITERAL_STRING);
  Sg_InsertBinding(lib, Sg_Intern(Sg_MakeString(UC("make-toplevel-closure"), SG_LITERAL_STRING)), SG_OBJ(&_sagittarius_vm_make_toplevel_closure_Stub));
