...
static SgObject closlib_slot_ref(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_SYMBOLP(name_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d967[0], SG_MAKE_STRING("symbol"), name_scm, SG_NIL);
...
static SgObject closlib_slot_setX(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_SYMBOLP(name_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d967[1], SG_MAKE_STRING("symbol"), name_scm, SG_NIL);
  name = SG_SYMBOL(name_scm);
  v_scm = SG_ARGREF(2);
  v = (v_scm);
  {
...
static SgObject closlib_slot_ref_using_accessor(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_SLOT_ACCESSORP(sa_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d967[2], SG_MAKE_STRING("slot-accessor"), sa_scm, SG_NIL);
...
static SgObject closlib_slot_set_using_accessorX(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_SLOT_ACCESSORP(sa_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d967[3], SG_MAKE_STRING("slot-accessor"), sa_scm, SG_NIL);
  sa = SG_SLOT_ACCESSOR(sa_scm);
  v_scm = SG_ARGREF(2);
  v = (v_scm);
  {
...
static SgObject closlib__25ensure_generic_function(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_SYMBOLP(name_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d967[6], SG_MAKE_STRING("symbol"), name_scm, SG_NIL);
  name = SG_SYMBOL(name_scm);
  lib_scm = SG_ARGREF(1);
  if (!SG_LIBRARYP(lib_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d967[6], SG_MAKE_STRING("library"), lib_scm, SG_NIL);
...
void Sg__Init_sagittarius_clos () {
  ...
  sg__rc.d967[0] = SG_MAKE_STRING("slot-ref");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d967[0]), &closlib_slot_ref__STUB);
  SG_PROCEDURE_NAME(&closlib_slot_ref__STUB) = sg__rc.d967[0];
  SG_PROCEDURE_NAME(&closlib_slot_setX__STUB) = sg__rc.d967[1];
  Sg_SetterSet(SG_PROCEDURE(&closlib_slot_ref__STUB), SG_PROCEDURE(&closlib_slot_setX__STUB), TRUE);
  sg__rc.d967[1] = SG_MAKE_STRING("slot-set!");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d967[1]), &closlib_slot_setX__STUB);
  SG_PROCEDURE_NAME(&closlib_slot_setX__STUB) = sg__rc.d967[1];
  sg__rc.d967[2] = SG_MAKE_STRING("slot-ref-using-accessor");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d967[2]), &closlib_slot_ref_using_accessor__STUB);
  SG_PROCEDURE_NAME(&closlib_slot_ref_using_accessor__STUB) = sg__rc.d967[2];
  sg__rc.d967[3] = SG_MAKE_STRING("slot-set-using-accessor!");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d967[3]), &closlib_slot_set_using_accessorX__STUB);
  SG_PROCEDURE_NAME(&closlib_slot_set_using_accessorX__STUB) = sg__rc.d967[3];
  sg__rc.d967[4] = SG_MAKE_STRING("class-of");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d967[4]), &closlib_class_of__STUB);
  SG_PROCEDURE_NAME(&closlib_class_of__STUB) = sg__rc.d967[4];
  sg__rc.d967[5] = SG_MAKE_STRING("is-a?");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d967[5]), &closlib_is_aP__STUB);
  SG_PROCEDURE_NAME(&closlib_is_aP__STUB) = sg__rc.d967[5];
  sg__rc.d967[6] = SG_MAKE_STRING("%ensure-generic-function");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d967[6]), &closlib__25ensure_generic_function__STUB);
  SG_PROCEDURE_NAME(&closlib__25ensure_generic_function__STUB) = sg__rc.d967[6];
}
