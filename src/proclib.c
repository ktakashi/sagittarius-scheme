...
static SgObject _sagittarius_compiler_procedure_procedure_name(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = SG_PROCEDURE_NAME(arg0);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_compiler_procedure_procedure_inliner(SgObject *args, int argc, void *data_)
{
  ...
  argumentAsProcedure(0, arg0_scm, arg0);
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = SG_PROCEDURE_INLINER(arg0);
;
    return SG_RETURN;
  }
}
...
static SgObject _sagittarius_compiler_procedure_procedure_inliner_set21(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(1, arg1);
  {
SgObject SG_RETURN = SG_UNDEF;SG_PROCEDURE_INLINER(arg0)=arg1;
SG_RETURN = SG_UNDEF;
;
    return SG_RETURN;
  }
...
static SgObject _sagittarius_compiler_procedure_procedure_reqargs(SgObject *args, int argc, void *data_)
{
  ...
  argumentAsProcedure(0, arg0_scm, arg0);
  {
int SG_RETURN;SG_RETURN = SG_PROCEDURE_REQUIRED(arg0);
;
...
static SgObject _sagittarius_compiler_procedure_procedure_optional(SgObject *args, int argc, void *data_)
{
  ...
  argumentAsProcedure(0, arg0_scm, arg0);
  {
int SG_RETURN;SG_RETURN = SG_PROCEDURE_OPTIONAL(arg0);
;
...
static SgObject _sagittarius_compiler_procedure_procedure3f(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(0, arg0);
  {
int SG_RETURN;SG_RETURN = SG_PROCEDUREP(arg0);
;
    return SG_MAKE_BOOL(SG_RETURN);
  }
}
static SG_DEFINE_SUBR(_sagittarius_compiler_procedure_procedure3f_Stub, 1, 0, _sagittarius_compiler_procedure_procedure3f, SG_FALSE, NULL);
...
static SgObject _sagittarius_compiler_procedure_inline3f(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(0, arg0);
  {
int SG_RETURN;SG_RETURN = (SG_PROCEDUREP(arg0) && !SG_FALSEP(SG_PROCEDURE_INLINER(arg0)));
;
    return SG_MAKE_BOOL(SG_RETURN);
  }
}
...
static SgObject _sagittarius_compiler_procedure_find_procedure(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(1, lib);
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_FindBinding(lib, name);
;
    return SG_RETURN;
  }
}
...
void Sg__Init_sagittarius_compiler_procedure()
{
  ...
  SG_PROCEDURE_NAME(&_sagittarius_compiler_procedure_procedure3f_Stub) = Sg_MakeString(UC("procedure?"), SG_LITERAL_STRING);
  Sg_InsertBinding(lib, Sg_Intern(Sg_MakeString(UC("procedure?"), SG_LITERAL_STRING)), SG_OBJ(&_sagittarius_compiler_procedure_procedure3f_Stub));
