...
static SgObject nullnewline(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;Sg_Printf(p, UC("\n"));
    return SG_RETURN;
  }
}
...
static SgObject nullvector_ref(SgObject *args, int argc, void *data_)
{
  ...
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_VectorRef(vec, i, SG_UNDEF);
;
    return SG_RETURN;
  }
}
...
static SgObject nullvector_set21(SgObject *args, int argc, void *data_)
{
  ...
  argumentRef(2, obj);
  {
SgObject SG_RETURN = SG_UNDEF;SG_RETURN = Sg_VectorSet(vec, i, obj);
;
    return SG_RETURN;
  }
}
