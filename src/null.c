        ...
        SG_FOR_EACH(cgen_24,rest) {
          {
            ...
            if (!(SG_INTP(v))) {
              if (!(SG_INTP(v))) {
                Sg_AssertionViolation(SG_INTERN("fx=?"), Sg_MakeString(UC("fixnum"), SG_LITERAL_STRING), v);
                return SG_UNDEF;
;
              }
;
        ...
        SG_FOR_EACH(cgen_29,rest) {
          {
            ...
            if (!(SG_INTP(v))) {
              Sg_AssertionViolation(SG_INTERN("fxmac"), Sg_MakeString(UC("fixnum"), SG_LITERAL_STRING), v);
              return SG_UNDEF;
;
            }
;
...
;
      ...
      if (!(SG_INTP(o))) {
        Sg_AssertionViolation(SG_INTERN("fx-"), Sg_MakeString(UC("fixnum"), SG_LITERAL_STRING), o);
        return SG_UNDEF;
;
      }
;
...
static SgObject nullfxand(SgObject *args, int argc, void *data_)
{
  ...
  retrieveOptionalArguments(0, rest);
  {
    int SG_RETURN;
    {
      ...
      {
        SgObject cgen_36;
        SG_FOR_EACH(cgen_36,args) {
          {
            SgObject v = SG_CAR(cgen_36);
            if (!(SG_INTP(v))) {
              Sg_AssertionViolation(SG_INTERN("fxand"), Sg_MakeString(UC("fixnum"), SG_LITERAL_STRING), v);
              return SG_UNDEF;
;
            }
;
...
static SgObject nullfxior(SgObject *args, int argc, void *data_)
{
  ...
  retrieveOptionalArguments(0, rest);
  {
    int SG_RETURN;
    {
      ...
      {
        SgObject cgen_37;
        SG_FOR_EACH(cgen_37,args) {
          {
            SgObject v = SG_CAR(cgen_37);
            if (!(SG_INTP(v))) {
              Sg_AssertionViolation(SG_INTERN("fxior"), Sg_MakeString(UC("fixnum"), SG_LITERAL_STRING), v);
              return SG_UNDEF;
;
            }
;
...
static SgObject nullfxxor(SgObject *args, int argc, void *data_)
{
  ...
  retrieveOptionalArguments(0, rest);
  {
    int SG_RETURN;
    {
      ...
      {
        SgObject cgen_38;
        SG_FOR_EACH(cgen_38,args) {
          {
            SgObject v = SG_CAR(cgen_38);
            if (!(SG_INTP(v))) {
              Sg_AssertionViolation(SG_INTERN("fxxor"), Sg_MakeString(UC("fixnum"), SG_LITERAL_STRING), v);
              return SG_UNDEF;
;
            }
;
  ...
  retrieveOptionalArguments(1, rest);
  {
    ...
    if (SG_NULLP(rest)) {
    ...
    } else {
      {
        ...
        {
          SgObject cgen_39;
          SG_FOR_EACH(cgen_39,SG_CDR(rest)) {
            {
  ...
  retrieveOptionalArguments(1, rest);
  {
    ...
    if (SG_NULLP(rest)) {
    ...
    } else {
      {
        ...
        {
          SgObject cgen_40;
          SG_FOR_EACH(cgen_40,SG_CDR(rest)) {
            {
  ...
  retrieveOptionalArguments(1, rest);
  {
    ...
    if (SG_NULLP(rest)) {
    ...
    } else {
      {
        ...
        {
          SgObject cgen_41;
          SG_FOR_EACH(cgen_41,SG_CDR(rest)) {
            {
...
;
    {
      ...
      {
        SgObject cgen_42;
        SG_FOR_EACH(cgen_42,fields) {
          {
            SgObject field = SG_CAR(cgen_42);
