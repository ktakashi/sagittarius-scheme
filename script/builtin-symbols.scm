...
(define c-header "../src/sagittarius/private/builtin-symbols.h")

(define (header out)
  (format out "/* This file is automatically generated by builtin-symbols.scm. DO NOT EDIT! */~%")
  (format out "#ifndef BUILTIN_PRIVATE_SYMBOL_H__~%")
  (format out "#define BUILTIN_PRIVATE_SYMBOL_H__~%")
  ...
  (format out "#endif /* BUILTIN_PRIVATE_SYMBOL_H__ */~%"))
