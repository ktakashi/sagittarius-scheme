...
(define-constant VALUES 61)
(define-constant EQ 62)
(define-constant EQV 63)
(define-constant NULLP 64)
(define-constant PAIRP 65)
(define-constant SYMBOLP 66)
(define-constant VECTOR 67)
(define-constant VECTORP 68)
(define-constant VEC_LEN 69)
(define-constant VEC_REF 70)
(define-constant VEC_SET 71)
(define-constant LREF_PUSH 72)
(define-constant FREF_PUSH 73)
(define-constant GREF_PUSH 74)
(define-constant CONST_PUSH 75)
(define-constant CONSTI_PUSH 76)
(define-constant GREF_CALL 77)
(define-constant GREF_TAIL_CALL 78)
(define-constant SET_CAR 79)
(define-constant SET_CDR 80)
(define-constant CAAR 81)
(define-constant CADR 82)
(define-constant CDAR 83)
(define-constant CDDR 84)
...
(define-constant INSTRUCTION_COUNT 91)
(define (lookup-insn-name insn)
  (cond
    ...
    ((eqv? insn 61) '(VALUES 1 0 #t #f))
    ((eqv? insn 62) '(EQ 0 0 #t #f))
    ((eqv? insn 63) '(EQV 0 0 #t #f))
    ((eqv? insn 64) '(NULLP 0 0 #t #f))
    ((eqv? insn 65) '(PAIRP 0 0 #t #f))
    ((eqv? insn 66) '(SYMBOLP 0 0 #t #f))
    ((eqv? insn 67) '(VECTOR 1 0 #t #f))
    ((eqv? insn 68) '(VECTORP 0 0 #t #f))
    ((eqv? insn 69) '(VEC_LEN 0 0 #t #f))
    ((eqv? insn 70) '(VEC_REF 0 0 #t #f))
    ((eqv? insn 71) '(VEC_SET 0 0 #t #f))
    ((eqv? insn 72) '(LREF_PUSH 1 0 #t #f))
    ((eqv? insn 73) '(FREF_PUSH 1 0 #t #f))
    ((eqv? insn 74) '(GREF_PUSH 0 1 #t #f))
    ((eqv? insn 75) '(CONST_PUSH 0 1 #f #f))
    ((eqv? insn 76) '(CONSTI_PUSH 1 0 #f #f))
    ((eqv? insn 77) '(GREF_CALL 1 1 #t #f))
    ((eqv? insn 78) '(GREF_TAIL_CALL 1 1 #t #f))
    ((eqv? insn 79) '(SET_CAR 0 0 #t #f))
    ((eqv? insn 80) '(SET_CDR 0 0 #t #f))
    ((eqv? insn 81) '(CAAR 0 0 #t #f))
    ((eqv? insn 82) '(CADR 0 0 #t #f))
    ((eqv? insn 83) '(CDAR 0 0 #t #f))
    ((eqv? insn 84) '(CDDR 0 0 #t #f))
    ((eqv? insn 85) '(LREF_CAR 1 0 #t #f))
    ((eqv? insn 86) '(LREF_CDR 1 0 #t #f))
    ((eqv? insn 87) '(FREF_CAR 1 0 #t #f))
    ((eqv? insn 88) '(FREF_CDR 1 0 #t #f))
    ((eqv? insn 89) '(GREF_CAR 1 0 #t #f))
    ((eqv? insn 90) '(GREF_CDR 1 0 #t #f))
    (else 'unknown)))
