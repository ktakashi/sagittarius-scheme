...
(define-constant EQ 60)
(define-constant EQV 61)
(define-constant NULLP 62)
(define-constant VECTOR 63)
(define-constant VECTORP 64)
(define-constant VEC_LEN 65)
(define-constant VEC_REF 66)
(define-constant VEC_SET 67)
(define-constant LREF_PUSH 68)
(define-constant FREF_PUSH 69)
(define-constant GREF_PUSH 70)
(define-constant CONST_PUSH 71)
(define-constant CONSTI_PUSH 72)
(define-constant GREF_CALL 73)
(define-constant GREF_TAIL_CALL 74)
(define-constant INSTRUCTION_COUNT 75)
(define (lookup-insn-name insn)
  (cond
    ...
    ((eqv? insn 60) '(EQ 0 0 #t #f))
    ((eqv? insn 61) '(EQV 0 0 #t #f))
    ((eqv? insn 62) '(NULLP 0 0 #t #f))
    ((eqv? insn 63) '(VECTOR 1 0 #t #f))
    ((eqv? insn 64) '(VECTORP 0 0 #t #f))
    ((eqv? insn 65) '(VEC_LEN 0 0 #t #f))
    ((eqv? insn 66) '(VEC_REF 0 0 #t #f))
    ((eqv? insn 67) '(VEC_SET 0 0 #t #f))
    ((eqv? insn 68) '(LREF_PUSH 1 0 #t #f))
    ((eqv? insn 69) '(FREF_PUSH 1 0 #t #f))
    ((eqv? insn 70) '(GREF_PUSH 0 1 #t #f))
    ((eqv? insn 71) '(CONST_PUSH 0 1 #f #f))
    ((eqv? insn 72) '(CONSTI_PUSH 1 0 #f #f))
    ((eqv? insn 73) '(GREF_CALL 1 1 #t #f))
    ((eqv? insn 74) '(GREF_TAIL_CALL 1 1 #t #f))
    (else 'unknown)))
