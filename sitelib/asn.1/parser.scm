  ...
  (define asn.1-parser
    (lr-driver
      '#(((*default* -51)
         ...
         ((*default* *error*) (OF 11))
         ((*default* -52))
         ((*default* -51) (CLASS 2) (ASSIGN 12))
         ((*default* -53) (IMPLICIT 15) (EXPLICIT 14))
         ((*default* -39))
         ((*default* -37) (COMMA 18) (POSTRBRACE 17))
         ((*default* -2))
         ((*default* -47))
         ((*default* -3) (WORD 19))
         ((*default* *error*) (*eoi* 20))
         ((*default* *error*) (WORD 21))
         ((*default* -51) (CLASS 2) (COMPONENTS 1))
         ((*default* -53) (IMPLICIT 15) (EXPLICIT 14))
         ((*default* -54))
         ((*default* -55))
         ((*default* *error*)
        ...
        (lambda (___stack ___sp ___goto-table ___push yypushback)
          (let* (($3 (vector-ref ___stack (- ___sp 1)))
            ...
            (___push
              3
              5
              (make-asn.1-type :type $1 :child $2))))
        (lambda (___stack ___sp ___goto-table ___push yypushback)
          (let* (($1 (vector-ref ___stack (- ___sp 1))))
            (___push 1 6 $1)))
        (lambda (___stack ___sp ___goto-table ___push yypushback)
